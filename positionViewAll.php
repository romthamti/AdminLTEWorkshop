          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview ">
                ...
                <li class="nav-item">
                  <a href="positionViewAll.php.html" class="nav-link">
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">position v1</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">ข้อมูลตำแหน่ง</h3>
              ...
              <div class="card-body">
                <table id="tabledepartmemt" class="table table-bordered table-striped">
                  ...
                  if ($resultPos->num_rows > 0) {
                    while ($rowsItem = $resultPos->fetch_assoc()) {
                      
                    
                   ?>

                  <tr>
                    <td><?php echo $rowsItem["position_id "]; ?></td>
                    <td><?php echo $rowsItem["position_nametha"]; ?></td>
                    <td><?php echo $rowsItem["position_nameeng"]; ?></td>
                    ...
                    <td><button type="button" class="btn btn-outline-danger btn-block btn-sm"><i class="fa fa-trash" ></i> ลบข้อมูล</button></td>
                  </tr>
